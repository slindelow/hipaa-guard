...
def _load_registry(project_root: str) -> dict:
    registry_path = Path(project_root).parent / "config" / "baa_registry.json"
    # Also check relative to tools/ parent
    if not registry_path.exists():
        registry_path = Path(__file__).parent.parent / "config" / "baa_registry.json"
